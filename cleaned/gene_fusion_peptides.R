# Previously labeled as: noncanonicalpeptidesanalysis_GeneFusion_forpaper.R
# Gene fusion peptide detection and visualization across cell lines
...
# Gene fusion peptides are those WITHOUT ":" in their identifier (hotspot mutations use ":")
...
# --- Filter to Peptides Present in the Gene Fusion Library ---
...
# --- Filter to Gene Fusion Peptides Only ---
...
# --- Generate Per-Fusion Peptide Signal Plots ---
