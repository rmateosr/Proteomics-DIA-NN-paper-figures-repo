...
png("C:/Users/Raul/Dropbox/Papers/DIA-NN/Figures/Fig2d_hotspotmutationsSummary_oncoprint.png", width  = letterincheswidth *2/3 , height =letterinchesheight * 0.5,units = "in", res = 1000 )
