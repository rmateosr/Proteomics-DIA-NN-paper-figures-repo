...
#png("C:/Users/Raul/Documents/papers/SJ_paper/Ambiguous_082023/figures/Final_Figure_Plots/Fig4etest.png", width  = letterincheswidth*17/24/2, height =letterinchesheight * 0.5/4,units = "in", res = 1000 )

#pdf("Fig_test_KEAP1.pdf", width  = letterincheswidth  , height =letterinchesheight * 0.5)
