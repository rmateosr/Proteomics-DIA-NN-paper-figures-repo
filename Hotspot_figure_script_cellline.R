...
noncanonandcanonKEAP1 = noncanonandcanon


colnames(noncanonandcanonKEAP1)[1:20]

colnames(noncanonandcanonKEAP1)[1:2] <- str_sub(colnames(noncanonandcanonKEAP1)[1:2], start = 13, end = -5)

colnames(noncanonandcanonKEAP1)[3:20]<- str_sub(colnames(noncanonandcanonKEAP1)[3:20], start = 20, end = -5)


colnames(noncanonandcanonKEAP1) <- sub("_400ng_01$", ".1", colnames(noncanonandcanonKEAP1))
colnames(noncanonandcanonKEAP1) <- sub("_400ng_02$", ".2", colnames(noncanonandcanonKEAP1))
...
#pdf("Fig_KEAP1.pdf", width  = letterincheswidth  , height =letterinchesheight)
png("Fig_KEAP1.png", width  = letterincheswidth  , height =letterinchesheight,units = "in", res = 1000 )

noncanonLabel = as.character(unique(noncanonandcanonKEAP1$Label[noncanonandcanonKEAP1$Canon == FALSE]))

noncanonLabel = noncanonLabel[!duplicated(str_split_fixed(noncanonLabel,"_",2)[,1])]



noncanonandcanonKEAP1$Label[noncanonandcanonKEAP1$Canon == TRUE] = paste0(noncanonandcanonKEAP1$Label[noncanonandcanonKEAP1$Canon == TRUE], "_", noncanonandcanonKEAP1$Sequence[noncanonandcanonKEAP1$Canon == TRUE] )



cont = grep("KRAS",noncanonLabel )
#for(cont in 1:length(noncanonLabel)){
  noncanonandcanonKEAP1$Canon = factor(noncanonandcanonKEAP1$Canon, c("TRUE", "FALSE"))
  thisselection = noncanonandcanonKEAP1[agrep(noncanonLabel[cont],noncanonandcanonKEAP1$Label),]
  the_sequence = (str_split_fixed(thisselection$Label, "_", 4)[,4])[1]
  the_name = (str_split_fixed(thisselection$Label, "_", 4)[,1])[1]
  thenoncanonsequences =  (str_split_fixed(noncanonandcanonKEAP1$Label, "_", 4)[,4])
  thenoncanonnames =  (str_split_fixed(noncanonandcanonKEAP1$Label, "_", 4)[,1])
  thecanon = noncanonandcanonKEAP1[agrep(the_sequence, noncanonandcanonKEAP1$Sequence, 1),]
  thenoncanon = noncanonandcanonKEAP1[agrep(the_sequence, thenoncanonsequences, 1),]
  thenoncanon2 = noncanonandcanonKEAP1[grep(the_name, thenoncanonnames, 1),]
...
#pdf("Fig_TP53.pdf", width  = letterincheswidth  , height =letterinchesheight)
png("Fig_TP53.png", width  = letterincheswidth  , height =letterinchesheight,units = "in", res = 1000 )
...
#pdf("Fig_BRAF.pdf", width  = letterincheswidth  , height =letterinchesheight)
png("Fig_BRAF.png", width  = letterincheswidth  , height =letterinchesheight,units = "in", res = 1000 )
