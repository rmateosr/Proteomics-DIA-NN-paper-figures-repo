...
#png("C:/Users/Raul/Documents/papers/SJ_paper/Ambiguous_082023/figures/Final_Figure_Plots/Fig4e.png", width  = letterincheswidth*17/24/2, height =letterinchesheight * 0.5/4,units = "in", res = 1000 )

#pdf("Fig_test_KRAS.pdf", width  = letterincheswidth  , height =letterinchesheight * 0.5)
...
#pdf("Fig_test_TP53.pdf", width  = letterincheswidth  , height =letterinchesheight * 0.5)
...
#colnames(noncanonandcanonCTNNB1)[1:2] <- str_sub(colnames(noncanonandcanonCTNNB1)[1:2], start = 13, end = -5)

#colnames(noncanonandcanonCTNNB1)[3:20]<- str_sub(colnames(noncanonandcanonCTNNB1)[3:20], start = 20, end = -5)
...
#pdf("Fig_test_CTNNB1.pdf", width  = letterincheswidth  , height =letterinchesheight * 0.5)
