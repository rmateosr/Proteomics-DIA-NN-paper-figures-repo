...
png("Fig_KRAS_G12CcaseforWakate.png", width  = letterincheswidth * 0.5  , height =letterinchesheight * 0.5,units = "in", res = 1000 )
...
plot_data = plot_data[plot_data$Canon == TRUE | plot_data$Gene_and_mut == "KRAS_G12_C:384_LVVVGACGVGK",]
