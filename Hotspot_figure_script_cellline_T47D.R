...
#pdf("Fig_test_TP53.pdf", width  = letterincheswidth  , height =letterinchesheight)
png("Fig_test_TP53_T47D.png", width  = letterincheswidth  , height =letterinchesheight,units = "in", res = 1000 )
...
thisselectionandcanon = thisselectionandcanon[(thisselectionandcanon$Sequence  != "") |  substring(thisselectionandcanon$Gene_and_mut,1,9) ==  "TP53_L194" ,]
